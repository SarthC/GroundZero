  ...
  return (
    <div className="min-h-screen bg-[#F0F0F0]">
      ...
      <header className="bg-black text-white border-b-4 border-black">
        <div className="max-w-[1800px] mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div
              className="w-12 h-12 flex items-center justify-center border-4 border-white"
              style={{ backgroundColor: "#AEFF00", boxShadow: "4px 4px 0px rgba(255,255,255,0.3)" }}
            >
      ...
      <main className="max-w-[1800px] mx-auto px-4 py-6 space-y-6">
        ...
        {/* ─── Filters ─── */}
        <div className="neu-card flex flex-wrap items-end gap-3">
          ...
          <button onClick={loadWells} className="neu-btn flex items-center gap-2">
          ...
          {TABS.map((tab) => (
            <button
              ...
              className={`px-6 py-3 font-bold uppercase tracking-wider text-sm border-4 border-black transition-all ${
                activeTab === tab.id
                  ? "bg-[#FFE600] shadow-none translate-x-[2px] translate-y-[2px]"
                  : "bg-white"
              }`}
              style={{
